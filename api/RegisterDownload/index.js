...
// The download URL we hand back. Kept in sync with /api/Download for v2.3.1.
// Points at the /api/download function so we still get the App Insights hit
// on the actual file fetch too.
const DOWNLOAD_URL = "/api/download?key=v231";
...
module.exports = async function (context, req) {
  ...
  const version = safeString(payload.version, 20)  || "v2.3.1";
